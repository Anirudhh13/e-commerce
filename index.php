...
<nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
    <ul class="navbar-nav me-auto">
        ...
        if(!isset($_SESSION['username'])){
          ...
          <a class='nav-link' href='./user_area/user_login.php'>Welcome Guest</a></li>";
         }else{
          echo "<li class='nav-item'>
          <a class='nav-link' href='./user_area/profile.php'>Welcome ".$_SESSION['username']."</a></li>";
         }
...
<div class="bg-info p-3 text-center">
    <p>All rights reserved © - Designed by Anirudh-2023
    </p>
</div>
